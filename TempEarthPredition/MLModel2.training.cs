...
namespace TempEarthPredition
{
    public partial class MLModel2
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:10,seriesLength:71,trainSize:124,horizon:10,outputColumnName:@"TempC",inputColumnName:@"TempC",confidenceLowerBoundColumn:@"TempC_LB",confidenceUpperBoundColumn:@"TempC_UB");
